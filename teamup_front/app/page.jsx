  ...
  return (
    <main className="min-h-screen w-full grid place-items-center landing-bg px-6">
      ...
      <style jsx global>{`
        ...
        /* ชั้นล่าง: ภาพ KMITL เบลอ */
        .landing-bg::before{
          content: "";
          position: absolute;
          inset: -20px;
          background: url("https://www.kmitl.ac.th/sites/default/files/2021-08/_MG_5_11.jpg") center / cover no-repeat;
        ...
        /* ชั้นกลาง: gradient เคลื่อนไหว (อยู่เหนือภาพ แต่ใต้การ์ด) */
        .landing-bg::after{
          content: "";
          position: absolute;
          inset: 0;
